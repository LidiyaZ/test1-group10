...
//находим текст заголовка MainPage
        WebElement productNameMainPage = driver.findElement(By.cssSelector("#box-campaigns div.name"));
...
// у которого в RGBa представлении каналы G и B имеют нулевые значения) для MAIN PAGE
            ...
            int indexSPWeightMP = productSPWeightMP.indexOf("700"); //подтверждаем, что цена жирная
